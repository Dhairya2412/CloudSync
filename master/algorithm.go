...
import "github.com/Yashs1623/Load_balancer_Fyp/internal"

func GetWeight(basedMetrics internal.ContainerBasedMetric) float64 {
	return 0.4*float64(basedMetrics.CpuPercent) + 0.5*basedMetrics.MemUsedPercent + 0.1*basedMetrics.DiskUsagePercent
}
